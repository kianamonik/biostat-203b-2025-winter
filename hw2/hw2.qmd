...
system.time(adm_tidy2 <- readr::read_csv("~/mimic/hosp/admissions.csv.gz", col_types = col_types_spec))
pryr::object_size(adm_tidy2)
str(adm_tidy2)
```
The run time decreases by 0.116 seconds and the memory usage decreases by 6.55 MB.
