...
**Solution:** Displaying the number of lines in each data file
```{bash}
for datafile in ~/mimic/hosp/{a,l,pa}*.gz
do
  echo -n "$datafile: "
...
**Solution:** Done. Also, the unusual occurance in the ouput for `cal 9 1752` is that the calender skips sept 3-13 in 1752. Upon further research, I found the reason for this is that 1752 was the year that in the British Empire adopted the Gregorian calendar and 11 days were dropped.
